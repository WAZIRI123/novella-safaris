...
<section class="page-banner" style="background-image:url('https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?auto=format&fit=crop&w=1920&q=80');">
    <div class="container">
        <h1>About Novella</h1>
        <div class="breadcrumb"><a href="index.php">Home</a> <i class="bi bi-chevron-right"></i> <span>About Us</span></div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="split-row reverse" id="sustainability">
            ...
            <div class="split-content">
                ...
                <a href="contact.php" class="btn btn-navy">Support the Foundation <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>
    </div>
</section>
...
<section class="inner-cta">
    <div class="container">
        ...
        <a href="contact.php" class="btn btn-yellow btn-lg">Plan My Trip <i class="bi bi-arrow-right"></i></a>
    </div>
</section>
