...
<section class="page-banner" style="background-image:url('https://images.unsplash.com/photo-1547721064-da6cfb341d50?auto=format&fit=crop&w=1920&q=80');">
    <div class="container">
        <h1>Contact Us</h1>
        <div class="breadcrumb"><a href="index.php">Home</a> <i class="bi bi-chevron-right"></i> <span>Contact</span></div>
    </div>
</section>
...
<section>
    <div class="container">
        <div class="contact-wrap">
                ...
                <ul>
                    <li>
                        ...
                        <div>
                            ...
                            <span>Boma Road, Arusha, Tanzania</span>
                        </div>
                    </li>
                    <li>
                        ...
                        <div>
                            ...
                            <span>+255 754 000 000 (24/7)</span>
                        </div>
                    </li>
                    <li>
                        ...
                        <div>
                            <strong>Email</strong>
                            <span>info@novellasafaris.com</span>
                        </div>
                    </li>
                    <li>
            ...
            <form class="contact-form" onsubmit="event.preventDefault(); alert('Thanks! We will reply within 24 hours.'); this.reset();">
                ...
                <div class="field-row">
                    ...
                    <div>
                        ...
                        <input id="c-country" type="text" placeholder="Where are you from?" />
                    </div>
                </div>
                <div class="field-row">
                    <div>
                    ...
                    <div>
                        ...
                        <input id="c-phone" type="tel" placeholder="+1 555 000 0000" />
                    </div>
                </div>
                <div class="field-row">
                    <div>
                        <label for="c-interest">I'm interested in</label>
                        <select id="c-interest" required>
                            <option value="">Choose one…</option>
                            <option>Safari</option>
                            <option>Kilimanjaro Climb</option>
                            <option>Zanzibar Beach</option>
                            <option>Safari + Zanzibar Combo</option>
                    ...
                    <div>
                        ...
                        <input id="c-dates" type="text" placeholder="e.g. July 2026" />
                    </div>
                </div>
                <div class="field">
                    <label for="c-msg">Tell us about your dream trip</label>
                    <textarea id="c-msg" placeholder="Traveller count, budget range, must-see wildlife, honeymoon, family with kids…" required></textarea>
                </div>
