...
<section class="page-banner" style="background-image:url('https://images.unsplash.com/photo-1589197331516-4d84b72ebde3?auto=format&fit=crop&w=1920&q=80');">
    <div class="container">
        <h1>Zanzibar</h1>
        <div class="breadcrumb"><a href="index.php">Home</a> <i class="bi bi-chevron-right"></i> <span>Zanzibar</span></div>
    </div>
</section>
...
<section class="inner-cta">
    <div class="container">
        ...
        <a href="contact.php" class="btn btn-yellow btn-lg">Plan My Escape <i class="bi bi-arrow-right"></i></a>
    </div>
</section>
