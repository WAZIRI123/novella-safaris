            ...
            ->components([
                Tabs::make('Trip')
                    ->tabs([
                        Tab::make('Basics')
                            ->schema([
                                TextInput::make('country')->required()->helperText('Kenya, Rwanda, Uganda, Multi-country, etc.'),
                                ...
                                FileUpload::make('image')->image()->directory('other-country'),
                                TextInput::make('duration')->helperText('e.g. "8 Days"'),
                                TextInput::make('duration_days')->numeric()->label('Duration (days)'),
                                TextInput::make('duration_nights')->numeric()->label('Duration (nights)'),
                                TextInput::make('price_from')->numeric()->prefix('$')->label('Starting price'),
                                TextInput::make('category')->default('East Africa'),
                                TextInput::make('theme')->placeholder('Wildlife & Culture'),
