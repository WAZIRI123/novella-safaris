                    ...
                    ->tabs([
                        Tab::make('Basics')
                            ->schema([
                                ...
                                FileUpload::make('image')->image()->directory('special-packages'),
                                TextInput::make('duration')->helperText('e.g. "10 Days"'),
                                ...
                                TextInput::make('category')->default('Special Package'),
                                TextInput::make('theme')->placeholder('Honeymoon / Family / Luxury'),
