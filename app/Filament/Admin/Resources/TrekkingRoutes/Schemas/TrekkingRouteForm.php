...
namespace App\Filament\Admin\Resources\TrekkingRoutes\Schemas;
                    ...
                    ->tabs([
                        Tab::make('Basics')
                            ->schema([
                                ...
                                FileUpload::make('image')->image()->directory('trekking'),
                                TagsInput::make('features'),
                                TextInput::make('days')->numeric()->label('Days on the mountain'),
                                TextInput::make('duration_days')->numeric()->label('Total duration (days)'),
                                TextInput::make('duration_nights')->numeric()->label('Total duration (nights)'),
                                ...
                                TextInput::make('category')->default('Trekking'),
                                TextInput::make('theme')->placeholder('Adventure & Altitude'),
