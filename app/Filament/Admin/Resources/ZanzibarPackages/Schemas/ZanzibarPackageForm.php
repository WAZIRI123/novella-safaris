...
namespace App\Filament\Admin\Resources\ZanzibarPackages\Schemas;
                    ...
                    ->tabs([
                        Tab::make('Basics')
                            ->schema([
                                ...
                                FileUpload::make('image')->image()->directory('zanzibar'),
                                ...
                                TextInput::make('category')->default('Zanzibar'),
                                TextInput::make('theme')->placeholder('Beach & Culture'),
